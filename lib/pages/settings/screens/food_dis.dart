        ...
        _tabController!.addListener(() {
          if (_tabController!.indexIsChanging) {
            ...
            final selectedMenuCategory = foodDisplayData.firstWhere(
              (menuCategory) =>
                  menuCategory.catgVariantTypeId ==
                  selectedMenuCategoryId,
              orElse: () => foodDisplayData.first,
            );

            final selectedFoodCategoryId =
                selectedMenuCategory.foodCategories.first.foodItemCategoryId;

            ref
                .read(foodItemStateNotifierProvider.notifier)
                .selectMenuCategory(selectedMenuCategoryId,selectedFoodCategoryId);
          }
        });
