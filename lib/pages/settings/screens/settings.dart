          ...
          children: [
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<int>(
                  isExpanded: true,
                  value: settings.selectedPrintFormat, // Use selected value from state
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      final updatedSettings = settings.copyWith(selectedPrintFormat: value);
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        icon: Icon(Icons.add),
                        onPressed: () {
                          if (settings.selectedCopyCount < settings.maxPrintCopies) {
                            final updatedSettings = settings.copyWith(
                              selectedCopyCount: settings.selectedCopyCount + 1,
                            );
                            ref.read(settingsProvider.notifier).updateSettings(updatedSettings);
            ...
            SwitchListTile(
              ...
              onChanged: (bool value) {
                final updatedSettings = settings.copyWith(homeDeliveryFeature: value ? 1 : 0);
                ref.read(settingsProvider.notifier).updateSettings(updatedSettings);
              },
            ),
            SwitchListTile(
              ...
              onChanged: (bool value) {
                final updatedSettings = settings.copyWith(onlineOrderingFeature: value ? 1 : 0);
                ref.read(settingsProvider.notifier).updateSettings(updatedSettings);
              },
            ),
          ],
